...
\name{Runzi}{QIN}
\address{China, Shandong Province, Shandong University Zhongxin Campus}
\mobile{(+86) 13791083062}

\email{rqin0521@163.com}
...
\makecvfooter{\today}{Runzi QIN~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
