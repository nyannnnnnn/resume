...
\name{Nuoyuan}{YAN}
\address{Hong Kong Kowloon Clear Water Bay Hong Kong University of Science and Technology Tower B}
\mobile{(+852) 93344049}

\email{nyan@connect.ust.hk}
\github{nyannnnnnn}\
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}Computer Vision} % Your expertise/fields

\makecvfooter{\today}{Nuoyuan YAN~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
